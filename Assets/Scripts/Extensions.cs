...
public static class Extensions 
{
    ...
    static public Texture2D LoadImage( string path )
    {
        try
        {
            //Debug.Log( "Loading snapshot thumbnail from " + path );
        ...
        {
            Debug.LogError( "Loading image failed: " + e.ToString() );
        }
	...
	public static string ConvertBitsumishiStringToCorrectCase(string s)
	{
		s = s.ToUpper();
		s = s.Replace("A", "a");
		s = s.Replace("D", "d");
